  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mainImage}>
        <Image source={{ uri: 'https://cdn.glitch.global/baa27e89-4441-477e-b283-cb72b3cb13e4/Rectangle%2017.png?v=1730190525597' }} style={styles.mainImageContent} />
        <Text style={styles.mainTitle}>CHILL MIX</Text>
