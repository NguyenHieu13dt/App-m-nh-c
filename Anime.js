  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mainImage}>
        <Image source={{ uri: 'https://cdn.glitch.global/baa27e89-4441-477e-b283-cb72b3cb13e4/No%20time%20to%20die%20Pic%206.png?v=1730190082876' }} style={styles.mainImageContent} />
        <Text style={styles.mainTitle}>Anime OSTs</Text>
