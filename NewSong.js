  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mainImage}>
        <Image source={{ uri: 'https://cdn.glitch.global/baa27e89-4441-477e-b283-cb72b3cb13e4/image%208.png?v=1730190052636' }} style={styles.mainImageContent} />
        <Text style={styles.mainTitle}>Top New Songs</Text>
