  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mainImage}>
        <Image source={{ uri: 'https://cdn.glitch.global/baa27e89-4441-477e-b283-cb72b3cb13e4/pop.png?v=1730190144430' }} style={styles.mainImageContent} />
        <Text style={styles.mainTitle}>POP MIX</Text>
